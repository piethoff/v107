...
Die Apparaturkonstante ist in der Anleitung für die Kleine Kugel mit\mbox{$K_\text{kl}=\SI{0.0764e-6}{\pascal\cubic\meter\per\kilo\gram}$\cite{v107}} angegeben.
...
Die Reynolds-Zahl wird mithilfe von Gleichung \eqref{eq:dubbi} für Raumtemperatur bestimmt.
